 ...
 <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
                      ...
                      <div class="modal-body">
                        <form id="formdelete">
                            <div class="row col-md-12 mb-3">  
                                    <label for="kode_delete" class="col-sm-3 col-form-label">Kode Status</label>
                                    <div class="col-sm-3">
                                      <input disabled type="text" class="form-control"  name="kode_delete" id="kode_delete" value="" required>
                                    </div>
                            </div>
                            <div class="row col-md-12 mb-3">  
                                    <label for="div_delete" class="col-sm-3 col-form-label">Nama Status</label>
                                    <div class="col-sm-6">
    ...
    <script>
                ...
                $("#delete").on("click",function(e){
                    ...
                    $.ajax({
                        url:"<?= base_url; ?>/Status/deletedata",
                        type:"POST",
                        data:{kode:kode},
                            dataType:'json',                  
