                        ...
                        <div class="row col-md-12 mb-3">  
                            ...
                            <div class="row col-md-12">  
                                ...
                                <div class="col-sm-11 d-flex justify-content-end">
                                        ...
                                        <button  onclick="closetambah()" type="button" class="btn btn-secondary me-1 mb-3" data-bs-dismiss="modal">Close</button>
                                      </div>
          </form>
            </div>
    </div>
    ...
    $(document).ready(function(){
           ...
           $("#Create_member").on("click",function(e){
              ...
              let email = $("#email").val();
                ...
                $.ajax({
                  url:"<?=base_url?>/divisimember/tambahdivisimember",
                  method:'POST',
                  ...
                  success:function(result){
                    let status = result.error;
                      ...
                      $("#member_divisi").load("<?= base_url; ?>/divisimember/index",{kode:kode_div})
                      ); 
