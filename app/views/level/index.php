  ...
  <section id="master_divisi" class="section">
        <div class="card">
          <div class="card-body">
          <div id="header_data"></div>
            <div class ="col-md-12 col-12">
                <!-- <h3 class="text-center">Target upload</h3> -->
                    ...
                    <a href="<?= base_url; ?>/level/tambah" class="btn float-right btn-xs btn"> <i class="fa-regular fa-file"></i> </a>
                  </div>
            </div>
      <!-- Basic Tables start -->
  ...
  <section id="member_divisi" class="section">
  </section>
      ...
      //reset delete
            ...
            function get_header(){
                ...
                <div  class="page-heading mb-3">
                  ...
                  <h4 class="text-center">Master Level</h4>
                  </div>
                </div>
