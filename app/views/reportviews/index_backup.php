    ...
    <section id="tampildata" class="section">
        <div class ="card">
            ...
            <div class=" mt-4">
                ...
                <form id="form_filter">
                <div class="text-start row col-md-12">
                    <div style="width:18%;" class="row col-md-3">
                          ...
                          <div style="width:25%;" class="row col-md-3">
                            ...
                            <div style="width:25%;" class="row col-md-3">
                                    <label class="col-md-4 col-form-label">Tgl Akhir:</label>
                                    <div  style="width:55%;" class= "col-md-8">
                              ...
                              <div style="width:25%;" class="row col-md-3">
                                    <label class="col-md-4 col-form-label">Status</label>
									   <div style="width:55%;" class="col-sm-6">
 ...
 function  showhideuser(div_btn,use_btn){
  let nilai_12 = $(div_btn).val();
   ...
   $(document).on("click","#filterdata",function(e){
       ...
       get_data_User(start_date,end_date,divisi,status);
   })
   //end data
  });
...
//end format tanggal
    ...
    function get_data_User(start_date,end_date,divisi,status){
       // get_header();
        $.ajax({
                url:'<?= base_url; ?>/reportviews/laporandata1',
                method:'POST',
                dataType:'json',
                data:{start_date:start_date,end_date:end_date,divisi,status:status},     
                success:function(response){
                    ...
                    $.each(response,function(key,b){
                              dataTable +=`
                                          <tr>
                                            ...
                                            <td width="150px" class="text-start"><a href="<?=base_url?>/reportviews/listtransaksiviews?KodeKeluhan=${b.KodeKeluhan}" >${b.KodeKeluhan}<sup>${b.NoTransaksi}</sup></a></td>
