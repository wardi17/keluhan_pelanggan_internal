...
<script>
  $(document).ready(function(){
								...
								"render":function(data,type,row){
									 ...
									 if(type === 'display'){
										    let html  =`
                                              ...
                                              <a href='<?= base_url; ?>/reportviews/gettransaksibysatu?KodeKeluhan=${row.KodeKeluhan},Notransaksi=${row.NoTransaksi}'>${data}</a>
    ...
    <h4 class="text-center">List View</h4>
    </div></div>
    ...
    $("#tabelhead").empty().html(dataTable);
	   ...
	   function goBack(){
                ...
                window.location.replace(`<?=base_url?>/reportviews/index`);
            } 
