                        ...
                        success:function(result){
							...
							if(result.nilai == 0){
								...
								let email = email_rp.replace(/\s/g, '');
                                    ...
                                    title: result.error,
									html :`
									<a href="<?= base_url; ?>/whatsapp/hp1?'nama':'${nama}','email':'${email}','nohp':'${nohp1}'"><i class="fa-brands fa-whatsapp text-success"></i> ${nohp1}</a>
									,<br><a href="<?= base_url; ?>/whatsapp/hp1?'nama':'${nama}','email':'${email}','nohp':'${nohp2}'"><i class="fa-brands fa-whatsapp text-success"></i> ${nohp2}</a>`,
