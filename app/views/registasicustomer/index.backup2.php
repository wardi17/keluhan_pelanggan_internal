		...
		const datas ={
          ...
          $.ajax({
                        ...
                        success:function(result){
							...
							if(result.nilai == 0){
								let nohp1 = result.hp1;
								let nohp2 = result.hp2;
								...
								let email = result.email;
                                    ...
                                    title: result.error,
									html :`
									<form action="<?= base_url; ?>/whatsapp/hp1" method ="POST" id="formNoHP1">
									  <input type="hidden" name="nama" id="nama"  value="${nama}">
									  <input type="hidden" name="email" id="email"  value="${email}">
									  <input type="hidden" name="nohp" id="nohp" value="${nohp1}">
									  <button type="submit" class="btn-submit" id="Apinohp1xxx">${nohp1}</button>
									</form>
									
								,<br> <a href="<?= base_url; ?>/whatsapp/hp2?nama=${nama}?email=${email}?nohp=${nohp2}"><i class="fa-brands fa-whatsapp text-success"></i> ${nohp2}</a>`,
