<!-- Modal   email data  -->
<div class="modal fade" id="CatatanPerbaikan" tabindex="-1" role="dialog" aria-labelledby="CatatanPerbaikanModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class ="modal-content">
    <div class="modal-header">
        <h5 class="modal-title fs-5" id="Send_emailModalLabel">Catatan Perbaikan</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" id="close_email" aria-label="Close"></button>
                ...
                <textarea type="text" disabled style="height:120px; font-size:18px;" class="form-control"  id="prebaikan"></textarea>
                </div>
