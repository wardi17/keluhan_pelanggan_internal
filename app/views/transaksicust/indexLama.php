          ...
          <div class= "col-md-6">
                  ...
                  <div class="row col-md-12 mb-3">
                      ...
                      <div class="row col-md-12 mb-3">
                          ...
                          <div class="row col-md-12 mb-3">
                                        <label for="atten" class="col-sm-2 col-form-label">Atas Nama</label>
                                        <div class="col-sm-4">
                                          <input disabled type="text"class="form-control" name ="atten" id="atten" value="" required></input>
                                        </div>
                          </div>
                          <div class="row col-md-12 mb-3">
                                        <label for="address" class="col-sm-2 col-form-label">Alamat</label>
                                        <div class="col-sm-8">
                                        <textarea disabled style="height:100px;" class="form-control" name ="address" id="address" value="" required></textarea>
                                        </div>
                            </div>
                          ...
                          <div class="row col-md-12 mb-3">
                                        ...
                                        <div class="col-sm-6">
                                          <input disabled type="text"class="form-control" name ="phone" id="phone" value="" required></input>
                                        </div>
                          </div>
