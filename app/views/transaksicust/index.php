...
$kode_kln = (isset($data['kode_kln']))? $data['kode_kln'] : '';

$IDtype = (isset($data['idtype']))? $data['idtype'] : '';
$NoTanski = (isset($data['NoTanski']))? $data['NoTanski'] : '';

?>
<div id="main">
  <div class="card">
    <div class="card-header">
    <h5 id="notski">Keluhan Pelanggan</h5>
    </div>
    <div class="card-content">
      <div class="card-body">
      <form  id ="formtambah" class ="form form-horizontal">
        <div class="row col-md-12-col-12">
		<input hidden   type="text" id="No_urut" value="<?=$NoTanski?>" class="form-control">
		<input hidden   type="text" id="IDtype" value="<?=$IDtype?>" class="form-control">
		  <input hidden   type="text" id="kode_tambah" value="<?=$kode_kln?>" class="form-control">
         ...
         <!-- <div class= "col-md-6">
          ...
          <div class= "col-md-6">
						<div class="row col-md-12 mb-3">
							<label for="text" class="col-sm-2 col-form-label">ID</label>
							<div class="col-sm-4">
							  <input  disabled type="text" id="KodeKeluhan" class="form-control">
							</div>
						</div>
                          <div class="row col-md-12 mb-3">
...
// Format the date using moment.js
 ...
 let kode_tambah =$("#kode_tambah").val();
	
  let kode_t ="";
 if(kode_tambah.length == 0){
	kode_t = id_trns;
 }else{
	kode_t = kode_tambah;
 }
  ...
  /*	$.ajax({
			  url:'<?=base_url?>/customer/cekidtranksaksi',
			  method:'POST',
			  data:{'id_keluhan':id_trns},
			  dataType:'json',
  ...
  $("#KodeKeluhan").val(kode_t);
}


//set type keluhan
	 function SetTypekeluhan(){
		 ...
		 let noUrut = $("#No_urut").val();
		 
		
		  if(noUrut.length != 0){
			  let tampil =`<h5>Keluhan Pelanggan ${noUrut} </h5>`;
			  $("#notski").empty().html(tampil);
		  }
	 }

// end set type keluhan
</script>