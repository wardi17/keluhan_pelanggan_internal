  ...
  <section class="section">
      ...
      //reset delete
            ...
            function get_data_divisi(){
                ...
                $.ajax({
                        url:'<?= base_url; ?>/keluhan/tampildata',
                        method:'POST',
                        dataType:'json',      
            ...
            function get_header(){
                ...
                <h4 class="text-center">Master Keluhan </h4>
                </div></div>
                ...
                //   let substr_bulan = bulan.substr(0,3);
                    let dataTable =`
                                <table id="tabel1" class='display table-info' style='width:100%'>                    
                                                ...
                                                <tr>
                                                            <th style="width:2%">Kode Keluhan</th>
                                                            <th style="width:3%">Nama Keluhan</th>
